...
HD_PWD='C:/Projects/ERN24004/Projects/PMOD_AD1/PMOD_AD1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_ad1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmod_ad1_wrapper.tcl
