...
HD_PWD='C:/Projects/ERN24004/Projects/PMOD_AD1/PMOD_AD1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_ad1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pmod_ad1_wrapper.tcl -notrace
