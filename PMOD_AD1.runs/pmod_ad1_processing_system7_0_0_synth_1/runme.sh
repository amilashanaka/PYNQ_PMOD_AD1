...
HD_PWD='C:/Projects/ERN24004/Projects/PMOD_AD1/PMOD_AD1.runs/pmod_ad1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_ad1_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmod_ad1_processing_system7_0_0.tcl
